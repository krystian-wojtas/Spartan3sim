...
\begin{minipage}{11cm}
   ...
   %% \caption{Demostracja logiki alternatywy zrealizownanej na połączeniach}
\end{minipage}
\end{table}
...
Są to układy scalone realizujące wyspecyfikowane przez producenta operacje logiczne. Na samych przedstawionych połączeniach można osiągnąć logikę koniunkcji lub alternatywy. Nie da się jednak sygnałowi zaprzeczyć. Możnaby problem obejść używając mechanicznych przekaźników. Właściwsze mogą okazać się tranzystory, tudzież ich zestawy odpowiednio połączone i zatopione w gotowych scalakach logicznych nazywanych bramkami logicznymi.
...
\begin{minipage}{5cm}
   \centering
   \includegraphics[width=5cm]{grafika/cemi/4and.png}
   %% \caption*{negacja}
\end{minipage}
\begin{minipage}{5cm}
   \centering
